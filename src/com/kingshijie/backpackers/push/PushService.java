package com.kingshijie.backpackers.push;
...
public class PushService extends Service {
	...
	// Notification title
	public static String NOTIF_TITLE = "附近有新事件";
	// Notification id
	...
	private void showNotification(String text) {
		...
		n.icon = com.kingshijie.backpackers.R.drawable.iconmarka;
		n.when = System.currentTimeMillis();

		// Simply open the parent activity
		Intent intent = new Intent(this, EventActivity.class);
		Bundle bdl = new Bundle();
		bdl.putLong("event_id", Long.parseLong(msg[1]));
		intent.putExtras(bdl);
		PendingIntent pi = PendingIntent.getActivity(this, 0, intent, PendingIntent.FLAG_UPDATE_CURRENT);

		// Change the name of the notification here
		n.setLatestEventInfo(this, NOTIF_TITLE, msg[0], pi);
